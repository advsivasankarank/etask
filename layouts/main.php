...
$navItems = [
    ...
    ['key' => 'client_portal', 'label' => 'Client Portal', 'path' => '/client-portal/pso', 'permissions' => ['portal.self_access', 'portal.pso.create', 'portal.pso.review', 'portal.pso.approve', 'portal.pso.reject']],
