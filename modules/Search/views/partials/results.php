            ...
            <?php foreach (($sourceResults['items'] ?? []) as $row): ?>
                <div style="padding:14px 16px;border-radius:16px;background:#fff;border:1px solid rgba(15,76,92,0.08);">
                    ...
                    <?php elseif ($sourceKey === 'invoices'): ?>
                        ...
                        <a href="<?= e(url('/billing/show?id=' . $row['service_order_id'])) ?>" class="chip" style="margin-top:8px;">Open Billing</a>
                    ...
                    <?php elseif ($sourceKey === 'consultants'): ?>
                        ...
                        <a href="<?= e(url('/consultants/show?id=' . $row['service_order_id'])) ?>" class="chip" style="margin-top:8px;">Open Consultant Case</a>
                        ...
                        <div style="display:flex;gap:8px;flex-wrap:wrap;margin-top:8px;">
                            ...
                            <?php elseif ($row['linked_module'] === 'CONSULTANT'): ?>
                                <?php if ((int) ($row['consultant_service_order_id'] ?? 0) > 0): ?>
                                    <a href="<?= e(url('/consultants/show?id=' . ((int) ($row['consultant_service_order_id'] ?? 0)))) ?>" class="chip">Open Consultant</a>
                                <?php endif; ?>
                            <?php endif; ?>
                        </div>
                    <?php endif; ?>
