...
<head>
    ...
    <title>Reset Password | e-Pani</title>
    ...
    <div class="pw-container">
        <div class="pw-card">
            <section class="pw-left">
                <div class="eyebrow">e-Pani Password Reset</div>
                <h1>Create a new client portal password</h1>
                <p class="copy-text">Choose a strong password for your portal account. Once saved, you can sign in again from the client login screen.</p>
                <div class="feature-list">
                    <div class="feature-item"><span class="feature-dot"></span> Secure account recovery</div>
                    <div class="feature-item"><span class="feature-dot"></span> Protected records</div>
                    <div class="feature-item"><span class="feature-dot"></span> Role-based portal access</div>
                    <div class="feature-item"><span class="feature-dot"></span> Audit-ready login activity</div>
                </div>
            </section>
            ...
            <section class="pw-right">
                ...
                <p class="hint">Your verification is complete. Save the new password to reactivate access.</p>
                ...
                <div class="password-help">Use a strong password and keep it confidential. Minimum 8 characters with mixed case, number and special character.</div>

                <div class="form-links">
                    <div class="form-link"><a href="<?= e(url('/login?audience=portal')) ?>">Back to Client Login</a></div>
