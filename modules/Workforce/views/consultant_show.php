<section class="panel">
    ...
    <div class="toolbar"><div><div class="eyebrow">Workforce Module</div><h3 style="margin:0 0 6px;"><?= e($consultant['name']) ?></h3><div class="subtle"><?= e($consultant['firm_name'] ?: 'Consultant') ?> | <?= e($consultant['status']) ?></div></div>
    ...
    <div class="grid">
        ...
        <div class="metric"><strong>Status</strong><div style="margin-top:8px;"><?= e($consultant['status']) ?></div></div>
    </div>
    ...
    <div class="panel" style="box-shadow:none;margin-top:18px;background:linear-gradient(180deg,#fff,#f6faf7);">
        ...
        <?php if ($assignments === []): ?><p class="subtle">No assignments yet.</p><?php else: ?>
            ...
            <?php foreach ($assignments as $a): ?><tr><td><strong><?= e($a['assignment_title']) ?></strong></td><td><?= e($a['so_no'] ?: '-') ?></td><td><?= e($a['client_name'] ?: '-') ?></td><td><span class="chip"><?= e($a['status']) ?></span></td><td><?= e($a['due_date'] ?: '-') ?></td></tr><?php endforeach; ?>
            </tbody></table></div>
        <?php endif; ?>
    </div>
    ...
    <div class="panel" style="box-shadow:none;margin-top:18px;background:linear-gradient(180deg,#fff,#f6faf7);">
        ...
        <?php if ($bills === []): ?><p class="subtle">No bills yet.</p><?php else: ?>
            ...
            <?php foreach ($bills as $b): ?><tr><td><?= e($b['bill_no'] ?: '-') ?></td><td><?= e($b['bill_date'] ?: '-') ?></td><td>INR <?= e(number_format((float) ($b['total_amount'] ?? 0), 2)) ?></td><td><span class="chip"><?= e($b['status']) ?></span></td></tr><?php endforeach; ?>
            </tbody></table></div>
        <?php endif; ?>
    </div>
</section>
